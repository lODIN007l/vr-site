    ...
    <section className="mb-12 lg:mb-24 ">
      <div className="container mx-auto">
        <div className="flex  flex-col min-h-[480px] lg:space-x-20 lg:flex-row ">
          {/* imagenes  */}
          <div className="flex-1 flex space-x-6 items-center ;g:space-x-12 ">
          ...
          <div className="flex-1 flex flex-col items-start  justify-center mt-6  lg:mt-0 ">
            ...
            <p className="font-secondary mb-6 ">
              ...
              Voluptatibus, eos sunt. Exercitationem eius laboriosam dolore
              voluptatem illum est. Deserunt, accusamus ducimus voluptas ratione
              soluta iusto officia sapiente a odit? Inventore.
            </p>
